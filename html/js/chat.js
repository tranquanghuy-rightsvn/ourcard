...
(function () {
  var REPLIES = [
    'Thanks for your message. This demo chat is not connected to our team yet — the quickest way to reach us is Zalo or WhatsApp on (+84) 904 152 501.',
    'Noted. For a formal quote, email info@khtcard.com with the product codes and quantities and we reply within one working day.',
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    function autoReply() {
      var typing = el('div', 'chat__msg chat__msg--them chat__typing', '<span></span><span></span><span></span>');
    ...
    ui.launcher.addEventListener('click', function () { toggle(ui.panel.hidden); });
    ui.panel.querySelector('.chat__close').addEventListener('click', function () { toggle(false); });
